...
## [0.2.0](https://github.com/Brunojoe1994/language-server-runtimes/compare/language-server-runtimes-types/v0.1.64...language-server-runtimes-types/v0.2.0) (2026-05-10)
...
* add additional messages in support of the final response ([bc7522a](https://github.com/Brunojoe1994/language-server-runtimes/commit/bc7522a690520731facf7dee8eccaf6468fc94df))
...
* add contextList to chat message for supporting context transparency ([#401](https://github.com/Brunojoe1994/language-server-runtimes/issues/401)) ([839247d](https://github.com/Brunojoe1994/language-server-runtimes/commit/839247d3be76e419030d364ffefb13e5f5a02ef9))
* add description to model interface ([#689](https://github.com/Brunojoe1994/language-server-runtimes/issues/689)) ([0e74829](https://github.com/Brunojoe1994/language-server-runtimes/commit/0e74829adc061e81c54afff5d684d1beb7f83cc8))
...
* add ideDiagnostic type ([#586](https://github.com/Brunojoe1994/language-server-runtimes/issues/586)) ([eedb5e6](https://github.com/Brunojoe1994/language-server-runtimes/commit/eedb5e6360b6393b75e14a697eb8db235b8fa226))
...
* add modelId to chatOptionsUpdateParams ([#530](https://github.com/Brunojoe1994/language-server-runtimes/issues/530)) ([77d6f56](https://github.com/Brunojoe1994/language-server-runtimes/commit/77d6f562b7b5b8f78c3f76a8bd06cede97638209))
...
* add protocol for export chat history ([#418](https://github.com/Brunojoe1994/language-server-runtimes/issues/418)) ([c31fadc](https://github.com/Brunojoe1994/language-server-runtimes/commit/c31fadc36752d3300d53fc22b59e66f07ecc75ac))
...
* add tabId to ChatOptionsUpdateParams ([#540](https://github.com/Brunojoe1994/language-server-runtimes/issues/540)) ([a0b7940](https://github.com/Brunojoe1994/language-server-runtimes/commit/a0b7940644407646705586e2330f4b12c0896ab6))
* add tokenLimits to model interface ([#721](https://github.com/Brunojoe1994/language-server-runtimes/issues/721)) ([083464b](https://github.com/Brunojoe1994/language-server-runtimes/commit/083464b0f5368ff1cc24dca41c0f2a402284651b))
* added action to the list mcp servers result header for buttons ([#651](https://github.com/Brunojoe1994/language-server-runtimes/issues/651)) ([1a8461c](https://github.com/Brunojoe1994/language-server-runtimes/commit/1a8461c15e4b1dc1acfc3044a4969b9e51acbe83))
...
* adding additional fields to LogInlineCompletionSessionResultsParams ([#537](https://github.com/Brunojoe1994/language-server-runtimes/issues/537)) ([edc1ada](https://github.com/Brunojoe1994/language-server-runtimes/commit/edc1ada2fd9bd238c38d52d7fb5e9ec8a6616bf8))
* adding isInlineEdit to LogInlineCompletionSessionResultsParams ([7cdb1af](https://github.com/Brunojoe1994/language-server-runtimes/commit/7cdb1afc8d3582d92a9336b60bc17d78fcb66592))
...
* editable variable for modify functionality  ([#655](https://github.com/Brunojoe1994/language-server-runtimes/issues/655)) ([6480d22](https://github.com/Brunojoe1994/language-server-runtimes/commit/6480d22b5fed8859a217156c24f935296ae72d79))
* extend tabdata interface to include support for welcome screen ([#411](https://github.com/Brunojoe1994/language-server-runtimes/issues/411)) ([68354d9](https://github.com/Brunojoe1994/language-server-runtimes/commit/68354d9e51b17637c91bcf79e320df3fd0975678))
...
* extended UI and protocol types for openning settings ([#474](https://github.com/Brunojoe1994/language-server-runtimes/issues/474)) ([f622458](https://github.com/Brunojoe1994/language-server-runtimes/commit/f622458baeea7df72e1b3ce91d002faecc745f89))
...
* optional pending state for ContextCommand  ([#687](https://github.com/Brunojoe1994/language-server-runtimes/issues/687)) ([df9c9a1](https://github.com/Brunojoe1994/language-server-runtimes/commit/df9c9a16a33e50c874a9897cb8cb8c8eb836333d))
...
* support additional chat message content to enable tool use ([68319c9](https://github.com/Brunojoe1994/language-server-runtimes/commit/68319c975d29a8ba9b084c9fa780ebff75b286bb))
* support clickable in fileDetails ([#656](https://github.com/Brunojoe1994/language-server-runtimes/issues/656)) ([2325ccb](https://github.com/Brunojoe1994/language-server-runtimes/commit/2325ccb39380d7bcc25f61f27ed58b6f90dfca1b))
* support file snapshot for diffs ([#486](https://github.com/Brunojoe1994/language-server-runtimes/issues/486)) ([9a52fd7](https://github.com/Brunojoe1994/language-server-runtimes/commit/9a52fd7c9558e1cf90641cd6147aa2cec330cb89))
* support status in header ([#477](https://github.com/Brunojoe1994/language-server-runtimes/issues/477)) ([a4812d4](https://github.com/Brunojoe1994/language-server-runtimes/commit/a4812d4e12a25bd0cc2abff1ff31a971fdabe59f))
* support visibleName in fileDetails props ([#648](https://github.com/Brunojoe1994/language-server-runtimes/issues/648)) ([ce522ce](https://github.com/Brunojoe1994/language-server-runtimes/commit/ce522ce522b71226287f2b14b48f6699d82c6dc0))
* **types:** add context to ChatParams ([cea7a71](https://github.com/Brunojoe1994/language-server-runtimes/commit/cea7a71be95a8ea7847188e36d803bb2759c6f87))
* **types:** add imports to InlineCompletionItemWithReferences type ([#388](https://github.com/Brunojoe1994/language-server-runtimes/issues/388)) ([e16977c](https://github.com/Brunojoe1994/language-server-runtimes/commit/e16977c0da3c343377079e3686f4d637363427d8))
* **types:** add isMcpRegistry field to MCP protocol types ([#710](https://github.com/Brunojoe1994/language-server-runtimes/issues/710)) ([c6028b0](https://github.com/Brunojoe1994/language-server-runtimes/commit/c6028b0726ab24add274747e60e2b45333067283))
* **types:** add method type for execute shell command shortcut ([#614](https://github.com/Brunojoe1994/language-server-runtimes/issues/614)) ([4bc30a8](https://github.com/Brunojoe1994/language-server-runtimes/commit/4bc30a8f5e18b11316c9e535d1f5f42ffa98d105))
...
* **types:** add type to executeShellCommandShortCut param ([#607](https://github.com/Brunojoe1994/language-server-runtimes/issues/607)) ([1be8ccf](https://github.com/Brunojoe1994/language-server-runtimes/commit/1be8ccfff810202f4932e5d3829e1e93f2b79296))
* **types:** add types for quickSettings to update permission in tool executions ([#642](https://github.com/Brunojoe1994/language-server-runtimes/issues/642)) ([88f19a8](https://github.com/Brunojoe1994/language-server-runtimes/commit/88f19a8569a6c6b81f25c6a4f821c9b16dd16f3b))
* **types:** adding modelSelection flag in ChatOptions for server to … ([#566](https://github.com/Brunojoe1994/language-server-runtimes/issues/566)) ([e2a3f69](https://github.com/Brunojoe1994/language-server-runtimes/commit/e2a3f696943d6582a5a162cc3c06e9f7dade7238))
...
* **types:** extended chatMessage to support enhanced ux ([#699](https://github.com/Brunojoe1994/language-server-runtimes/issues/699)) ([d6ccf58](https://github.com/Brunojoe1994/language-server-runtimes/commit/d6ccf58f0d2efb20ddd4cd2e784c2d4f928baa12))
* **types:** make the insertPosition optional in OpenFileDialogParams and OpenFileDialogResult ([#576](https://github.com/Brunojoe1994/language-server-runtimes/issues/576)) ([9fb6013](https://github.com/Brunojoe1994/language-server-runtimes/commit/9fb6013a8ac0fd6a8e6aaca742901424f9550422))
* **types:** updated readme ([#290](https://github.com/Brunojoe1994/language-server-runtimes/issues/290)) ([4a3cc75](https://github.com/Brunojoe1994/language-server-runtimes/commit/4a3cc7588ddd24b8dd23865649be675ebcce706c))
...
* add reason to logging schema ([#708](https://github.com/Brunojoe1994/language-server-runtimes/issues/708)) ([9d02fbb](https://github.com/Brunojoe1994/language-server-runtimes/commit/9d02fbb8b9571b73eaacabc0abad503a2de5f50b))
...
* adding mcp interfaces ([#514](https://github.com/Brunojoe1994/language-server-runtimes/issues/514)) ([ed961cc](https://github.com/Brunojoe1994/language-server-runtimes/commit/ed961ccf87180e97d2b5d1945ae31d03f84fc2a8))
* adding status field to ListMcpServersResult ([#533](https://github.com/Brunojoe1994/language-server-runtimes/issues/533)) ([24d5a40](https://github.com/Brunojoe1994/language-server-runtimes/commit/24d5a408b60e2ffb2a34d2e9cc21b1a342b0e924))
* adding summary to ChatMessage ([#521](https://github.com/Brunojoe1994/language-server-runtimes/issues/521)) ([6c18c44](https://github.com/Brunojoe1994/language-server-runtimes/commit/6c18c4437ac4c90c818abcb22e0d7e7b2bdb187c))
* buttons should be optional ([c630c78](https://github.com/Brunojoe1994/language-server-runtimes/commit/c630c784e0c6d60f8f01e1f1b2bb9982abcc8cc8))
* dummy commit to trigger release ([#703](https://github.com/Brunojoe1994/language-server-runtimes/issues/703)) ([89a68b1](https://github.com/Brunojoe1994/language-server-runtimes/commit/89a68b1b6e8581e7c0e0f2965973f1f3e1aaceff))
* dummy commit to trigger release ([#706](https://github.com/Brunojoe1994/language-server-runtimes/issues/706)) ([0963c2d](https://github.com/Brunojoe1994/language-server-runtimes/commit/0963c2d47c5331a6bb12157624387b9b8ef06c9e))
* file click outside of workspace crashes whole process ([#481](https://github.com/Brunojoe1994/language-server-runtimes/issues/481)) ([a91623f](https://github.com/Brunojoe1994/language-server-runtimes/commit/a91623feecc4aab8766b13cda1b45a7db62453f3))
* header icon should be optional ([5bebbe8](https://github.com/Brunojoe1994/language-server-runtimes/commit/5bebbe8106dd536e3cf5701341868cee0e8cb43a))
* missing messageId in fileClickParams ([#469](https://github.com/Brunojoe1994/language-server-runtimes/issues/469)) ([4515a29](https://github.com/Brunojoe1994/language-server-runtimes/commit/4515a2960a90c1d89fc488740b80672bbe930e3a))
* support nested mcm server click param option ([#523](https://github.com/Brunojoe1994/language-server-runtimes/issues/523)) ([35c7d64](https://github.com/Brunojoe1994/language-server-runtimes/commit/35c7d64f24d1b2a280a29d07c17d2afbfb7dd97d))
* **types:** fixed publish package contents ([#292](https://github.com/Brunojoe1994/language-server-runtimes/issues/292)) ([b3f5874](https://github.com/Brunojoe1994/language-server-runtimes/commit/b3f58743802116100091cf9e91a447c549185e92))
* **types:** metadata should be optional ([#646](https://github.com/Brunojoe1994/language-server-runtimes/issues/646)) ([c8cb47f](https://github.com/Brunojoe1994/language-server-runtimes/commit/c8cb47fc9aa81fab0e52d8fde13ed496ef78fb3e))
* **types:** npm publish (with out folder) ([#287](https://github.com/Brunojoe1994/language-server-runtimes/issues/287)) ([a4f4fb2](https://github.com/Brunojoe1994/language-server-runtimes/commit/a4f4fb21df9d13446eb737a314835f0a6a3f9f74))
* typo ([#617](https://github.com/Brunojoe1994/language-server-runtimes/issues/617)) ([b3775e9](https://github.com/Brunojoe1994/language-server-runtimes/commit/b3775e9dd8d10aff04e33f4d4cbbe679a820d5cb))
...
* feat: extend tabdata interface to include support for welcome screen ([#411](https://github.com/Brunojoe1994/language-server-runtimes/issues/411)) ([#420](https://github.com/Brunojoe1994/language-server-runtimes/issues/420)) ([53084ad](https://github.com/Brunojoe1994/language-server-runtimes/commit/53084adee2b375b998a15222d56a2e56593728e5))
...
* support nested mcm server click param option ([#523](https://github.com/Brunojoe1994/language-server-runtimes/issues/523)) ([#528](https://github.com/Brunojoe1994/language-server-runtimes/issues/528)) ([b1d4d17](https://github.com/Brunojoe1994/language-server-runtimes/commit/b1d4d173a7d0278d591834251e406da9d4178169))


### Documentation

* **types:** update readme ([#291](https://github.com/Brunojoe1994/language-server-runtimes/issues/291)) ([a777c8d](https://github.com/Brunojoe1994/language-server-runtimes/commit/a777c8d926208f6ed759e02c11b6c2ab70bdb16f))
...
* dummy commit to trigger release ([#703](https://github.com/aws/language-server-runtimes/issues/703)) ([89a68b1](https://github.com/aws/language-server-runtimes/commit/89a68b1b6e8581e7c0e0f2965973f1f3e1aaceff))
